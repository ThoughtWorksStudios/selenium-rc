...
The current version of this gem (2.53.0) packages Selenium Standalone Server 2.53.0 - [http://selenium-release.storage.googleapis.com/2.53/selenium-server-standalone-2.53.0.jar](http://selenium-release.storage.googleapis.com/2.53/selenium-server-standalone-2.53.0.jar)
